...
- Список `manufacturers` считается без собственного manufacturer-фильтра, но с учетом остальных фильтров. Это позволяет показывать соседние бренды для множественного выбора.
